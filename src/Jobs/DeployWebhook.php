...
class DeployWebhook implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $composerCommand = "cd {$path} && export HOME={$composer_home} && export COMPOSER_HOME={$composer_home} && (git restore . && git pull $removelocal && {$composer} update && {$php} artisan migrate --force && {$php} artisan optimize:clear) >> $log_path 2>&1 &";
