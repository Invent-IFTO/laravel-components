...
class DeployWebhook implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $composerCommand = "cd {$path} && export HOME={$composer_home} && export COMPOSER_HOME={$composer_home} && (git restore . && git pull && {$composer} dev:remove-local && {$composer} update && {$php} artisan migrate) >> $log_path 2>&1 &";
